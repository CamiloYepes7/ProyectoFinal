...
public  class AdminController {
    @Autowired
    private app.controller.validator.PersonValidator personValidator;
    @Autowired
    private app.controller.validator.UserValidator userValidator;
    @Autowired
    private app.controller.validator.PartnerValidator partnerValidator;
    @Autowired
